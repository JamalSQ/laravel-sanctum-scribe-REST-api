    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-register">User registration.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="companies">
                    <a href="#companies">Companies</a>
                                ...
                                <a href="#companies-GETapi-companies">Display the list of companies.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="companies-POSTapi-companies">
                                <a href="#companies-POSTapi-companies">Store a new company.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="companies-GETapi-companies--id-">
                                <a href="#companies-GETapi-companies--id-">Display a specific company.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="companies-PUTapi-companies--id-">
                                <a href="#companies-PUTapi-companies--id-">Update a specific company.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="companies-DELETEapi-companies--id-">
                                <a href="#companies-DELETEapi-companies--id-">Delete a specific company.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This is the Documentation for REST API's</p>
<aside>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user email. Example: <code>qkunze@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user password (minimum 8 characters, at least one letter and one digit). Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-register">User registration.</h2>

<p>
</p>

<p>Registers a new user and returns a success message.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user name. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password (minimum 8 characters, at least one letter and one digit). Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
        </div>
        </form>
                ...
                <h1 id="companies">Companies</h1>
                                ...
                                <h2 id="companies-GETapi-companies">Display the list of companies.</h2>

<p>
</p>

<p>This endpoint returns all registered companies.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="companies-POSTapi-companies">Store a new company.</h2>

<p>
</p>

<p>Creates a new company record with the provided data.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Max 500 characters. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Unique email address. Example: <code>qkunze@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="POSTapi-companies"
               value="consequatur"
               data-component="body">
    <br>
<p>Max 500 characters. Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phoneNo</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phoneNo"                data-endpoint="POSTapi-companies"
               value="consequatur"
               data-component="body">
    <br>
<p>Exactly 11 digits. Example: <code>consequatur</code></p>
        </div>
        </form>

                    <h2 id="companies-GETapi-companies--id-">Display a specific company.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the company. Example: <code>17</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="company"                data-endpoint="GETapi-companies--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the company. Example: <code>17</code></p>
                    ...
                    <h2 id="companies-PUTapi-companies--id-">Update a specific company.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="company"                data-endpoint="PUTapi-companies--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the company. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="PUTapi-companies--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Max 500 characters. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="phoneNo"                data-endpoint="PUTapi-companies--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Exactly 11 digits. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="companies-DELETEapi-companies--id-">Delete a specific company.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="company"                data-endpoint="DELETEapi-companies--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the company. Example: <code>17</code></p>
